...
///
/// Initialization is resilient: if a clip is missing or invalid the matching
/// pool stays null and playback is a silent no-op, so the app never crashes or
/// blocks on audio. Real Creative-Commons-zero clips can be dropped into
/// `assets/sounds/` to enable sound; haptics work regardless.
class SoundService {
  AudioPool? _tapPool;
